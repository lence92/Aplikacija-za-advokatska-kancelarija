                    ...
                    @else
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/profile/'.Auth::user()->id) }}"><i class="fa fa-btn fa-user"></i>Профил</a></li>
                                <hr>
                                @if(Auth::user()->is_admin())
                                    <li><a href="{{ url('/addUser') }}"><i class="fa fa-btn fa-pencil"></i>Додади корисник</a></li>
                                @endif
                                <li><a href="{{ url('/addCase') }}"><i class="glyphicon glyphicon-briefcase"></i>  &nbsp Додади предмет </a></li>
                                <li><a href="{{ url('/addTask') }}"><i class="glyphicon glyphicon-list-alt"></i>  &nbsp Додади задача </a></li>
                                <hr>
